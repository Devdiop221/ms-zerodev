...
export class PostUpdateComponent implements OnInit {
  ...
  protected updateForm(post: IPost): void {
    ...
    this.tagsSharedCollection = this.tagService.addTagToCollectionIfMissing<ITag>(this.tagsSharedCollection, post.tag);
  }
  ...
  protected loadRelationshipsOptions(): void {
    this.tagService
      ...
      .pipe(map((tags: ITag[]) => this.tagService.addTagToCollectionIfMissing<ITag>(tags, this.post?.tag)))
