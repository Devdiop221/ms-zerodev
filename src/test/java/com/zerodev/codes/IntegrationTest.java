...
import com.zerodev.codes.ZerodevApp;
import com.zerodev.codes.config.AsyncSyncConfiguration;
import com.zerodev.codes.config.EmbeddedMongo;
...
@SpringBootTest(classes = { ZerodevApp.class, AsyncSyncConfiguration.class })
@EmbeddedMongo
