package com.zerodev.codes.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.zerodev.codes.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.zerodev.codes.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
