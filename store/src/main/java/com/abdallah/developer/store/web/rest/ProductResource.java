...
import com.abdallah.developer.store.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.abdallah.developer.store.domain.Product}.
 */
@RestController
@RequestMapping("/api")
